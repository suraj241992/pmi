...
<div class="body-content outer-top-bd">
	...
	<h1><a href="blog-details.html">the new product from apple company</a></h1>
	...
	<div class="tab-content">
	   <div class="tab-pane active m-t-20" id="popular">
		<div class="blog-post inner-bottom-30 " >
			<img class="img-responsive" src="images/blog-post/sm1.jpg" alt="">
		...
		<div class="blog-post" >
			<img class="img-responsive" src="images/blog-post/sm2.jpg" alt="">
			<h4><a href="blog-details.html">Simple Blog Post</a></h4>
			<span class="author">Michael</span>
			<span class="review">6 Comments</span>
			<span class="date-time">24/06/14</span>
